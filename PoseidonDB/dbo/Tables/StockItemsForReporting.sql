CREATE TABLE [dbo].[StockItemsForReporting]
(
	...
	CONSTRAINT [FK_StockItemsForReporting_Product] FOREIGN KEY ([ProductId]) REFERENCES [Products]([Id]),
	CONSTRAINT [FK_StockItemsForReporting_Stock] FOREIGN KEY ([StockId]) REFERENCES [Stock]([Id])
)